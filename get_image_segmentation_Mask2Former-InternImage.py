...
def main():
    ...
    parser.add_argument('config',  default="ops/segmentation/configs/ade20k/mask2former_internimage_h_896_80k_cocostuff2ade20k_ss.py", help='Config file')
    parser.add_argument('checkpoint', default="ops/segmentation/checkpoints/mask2former_internimage_h_1024x1024_80k_mapillary2cityscapes.pth", help='Checkpoint file')
